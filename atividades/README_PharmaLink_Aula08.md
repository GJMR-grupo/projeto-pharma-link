...
## Tema
Revisão integradora e prontidão N1
...
2. corrigir incoerências entre contexto, requisitos, backlog e arquitetura;
3. realizar peer review de outro grupo e registrar Issue pertinente;
4. consolidar checklist de prontidão para N1.

## Dicas
- Preserve o histórico das decisões.
- Priorize incoerências que afetam rastreabilidade.

## Evidências mínimas da entrega
- Issue identificada como `Aula 08`.
